...
#   buttonA = (entry["buttons"]["A"]["X"], entry["buttons"]["A"]["Y"])
#   buttonB = (entry["buttons"]["B"]["X"], entry["buttons"]["B"]["Y"])

#   xAttempts = buttonA[0] * buttonB[0] * buttonA[1] * buttonB[1]
#   print(xAttempts)
#   b = int(goal[0] / buttonB[0])
#   a = 0
#   bEnd = max(0, b - xAttempts)
#   match = False

#   while not match and b >= bEnd:
#     while b * buttonB[0] + a * buttonA[0] < goal[0]:
#       a += 1
#     if b * buttonB[0] + a * buttonA[0] == goal[0] and b * buttonB[1] + a * buttonA[1] == goal[1]:
#       match = True
#       break
#     # print(a, b, b * buttonB[0] + a * buttonA[0],  b * buttonB[1] + a * buttonA[1])
#     b -= 1
#   if match:
#     total += a * 3 + b
...
for entry in entries:
  goal = (10000000000000 + entry["target"]["X"], 10000000000000 + entry["target"]["Y"])
